...
This directory contains ADRs documenting key design decisions for the
exsoil-nsf-prototype container infrastructure.

| ADR | Title | Status |
|-----|-------|--------|
| [0001](0001-arm64-base-image.md) | Base Image for ARM64 Container Rebuild | Accepted |
...
| [0006](0006-cmip-era-override-for-neon.md) | Set CLM_CMIP_ERA=cmip6 for NEON Runs | Proposed |
